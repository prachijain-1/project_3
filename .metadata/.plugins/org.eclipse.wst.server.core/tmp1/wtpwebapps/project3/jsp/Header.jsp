...
<script src="/project3/js/jquery.min.js"></script>

<link rel="stylesheet" href="/project3/js/bootstrap.min.css">

<link rel="stylesheet" href="/project3/js/font-awesome.min.css">
...
<link rel="stylesheet" href="/project3/css/jquery-ui.css">
<script src="/project3/js/jquery.min.js"></script>
<script src="/project3/js/jquery-1.12.4.js"></script>
<script src="/project3/js/jquery-ui.js"></script>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: rgba(28, 35, 49, 0.6);">
		<div class="container-fluid">
			<ul class="nav navbar-nav navbar-left" style="background-color: #3030358f">
				<img src="/project3/image/download.png" width="130" height="52" class="img-responsive">
			</ul>
