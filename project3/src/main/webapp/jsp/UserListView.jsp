...
<style type="text/css">
body {
	background-image: url("/project3/image/fff.jpg");
...
<body>
    ...
    <br>
         ...
         <H2 align="center">  <span class="glyphicon glyphicon-list"></span><b> User List</b> </H2>
	    ...
	    <div class="container-fluid text-center">
           <div class="form-inline" >
				...
				<div class="form-group text-center">
					...
					placeholder="Enter Login Id" size=15 value="<%=ServletUtility.getParameter("login", request)%>">
				</div>
              ...
              <thead>
				...
				int count = l.size();
                    ...
                    while (it.hasNext()) {
                        ...
                        UserDTO userdt = model.findByPK(dto.getId());
