...
<body>
    ...
    <br>
         ...
         <H2 align="center">  <span class="glyphicon glyphicon-list"></span><b> Course List</b> </H2>
              ...
              <thead>
				...
				int count = l.size();
                    ...
                    while (it.hasNext()) {
                        ...
                        dto = it.next();
                        CourseDTO coursedto = model.findByPK(dto.getId());
                ...
                <tr>
					...
					<td style="size: 20%; text-align: center;"><a href="CourseCtl?id=<%=dto.getId()%>">
